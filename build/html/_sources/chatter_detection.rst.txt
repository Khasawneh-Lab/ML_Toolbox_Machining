...
Chatter Detection Module Documentation
======================================
...
.. toctree::
   ...
   Wavelet Packet Transform (WPT) <WPT.rst>
   Ensemble Empirical Mode Decomposition (EEMD) <EEMD.rst>
   Dynamic Time Warping (DTW) <DTW.rst>
   Fast Fourier Transfrom (FFT) <FFT.rst>
   Power Spectral Density (PSD) <PSD.rst>
   Autocorrelation Function (ACF) <ACF.rst>
   Topological Data Analysis (TDA) <TDA.rst>