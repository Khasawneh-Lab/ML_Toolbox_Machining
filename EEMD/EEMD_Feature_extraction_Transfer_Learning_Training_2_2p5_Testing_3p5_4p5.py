...
#folderToLoad_test1 = os.path.join('D:'+os.path.sep,
#                                    'Data Archive',
#                                    'Cutting Tool Experiment Data',
#                                    'DownSampled_Data',
#                                    '2inch',
#                                    )
#sys.path.insert(0,folderToLoad_test1)
#os.path.join(folderToLoad_test)
#
#folder_test1 = os.path.join('D:'+os.path.sep,
#                                    'Data Archive',
#                                    'Cutting Tool Experiment Data',
#                                    'eIMFs',
#                                    '2inch',
...
#folderToLoad_test2 = os.path.join('D:'+os.path.sep,
#                                    'Data Archive',
#                                    'Cutting Tool Experiment Data',
#                                    'DownSampled_Data',
#                                    '2.5inch',
#                                    )
#sys.path.insert(0,folderToLoad_test2)
#os.path.join(folderToLoad_test2)
#
...
#training sets
labelrpm_training1 = np.zeros((numberofcase1,1))
labelrpm_training2 = np.zeros((numberofcase2,1))

labeldoc_training1 = np.zeros((numberofcase1,1))
labeldoc_training2 = np.zeros((numberofcase2,1))

#2 inch
for i in range (0,numberofcase_training1):
    name1 =  'chatter_1training%d' %(i+1)
    nameofdata1 = os.path.join(folderToLoad_training1,'%s_downsampled.mat' %(namets1[i]))
    if namets3[i][5]!='_':
...
for i in range (0,numberofcase_training2):
    ...
    nameofdata1 = os.path.join(folderToLoad_training2,'%s_downsampled.mat' %(namets2[i]))
    if namets4[i][5]!='_':
...
#test set
labelrpm_test1 = np.zeros((numberofcase3,1))
labelrpm_test2 = np.zeros((numberofcase4,1))

labeldoc_test1 = np.zeros((numberofcase3,1))
labeldoc_test2 = np.zeros((numberofcase4,1))
...
for i in range (0,numberofcase_test1):
    ...
    nameofdata2 = os.path.join(folderToLoad_test3,'%s_downsampled.mat' %(namets3[i]))
    if namets1[i][5]!='_':
...
for i in range (0,numberofcase_test2):
    ...
    nameofdata2 = os.path.join(folderToLoad_test4,'%s_downsampled.mat' %(namets4[i]))
    if namets2[i][5]!='_':
...
for i in range(0,lengthofcases):
    dataname = 'IMFs_%dinch_Divided_Data_IMFs_Case%d' %(training_case_1,i+1) 
...
for i in range(0,lengthofcases):
    dataname = 'IMFs_%.1finch_Divided_Data_IMFs_Case%d' %(test_case1,i+1) 
