function fig = WP_Energy_Ratio(L, stickout_length,list_name,ts_no,WF,N,rown_no,column,no,Fs) 
...
% their Wavelet Packet Decomposition. Energy ratios of each wavelet packet,
% reconstructed wavelet packets in time domain for each transform and FFT 
% of these packets are plotted as outputs.
% 
% INPUT:
